function [E_matrices_in_order, A_inverse] = ExtraCredit()
    ...
    E1 = eye(3); % Enter your first elementary matrix
    A = E1 * A;
    disp("A now is...")
    disp(A); % We want to see A being reduced to the identity

    E2 = [1,0,0;1,1,0;-1,0,1]; % Enter your second elementary matrix
    A = E2 * A;
    disp("A now is...")
    disp(A);
    
    % Repeat for E3, E4, ... as needed
    E3 = [1,0,0;0,1,0;0,-1,1]; % Enter your second elementary matrix
    A = E3 * A;
    disp("A now is...")
    disp(A);
    
    E4 = [1,0,0;0,0.5,0;0,0,1]; % Enter your second elementary matrix
    A = E4 * A;
    disp("A now is...")
    disp(A);

    E5 = [1,0,0;0,1,-0.5;0,0,1]; % Enter your second elementary matrix
    A = E4 * A;
    disp("A now is...")
    disp(A);

    E6 = [1,0,2;0,1,0;0,0,1]; % Enter your second elementary matrix
    A = E4 * A;
    disp("A now is...")
    disp(A);

    E7 = [1,-2,0;0,1,0;0,0,1]; % Enter your second elementary matrix
    A = E4 * A;
    disp("A now is...")
    disp(A);
